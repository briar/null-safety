 ...
 * <li> There is a default nullness annotation applied to a more tightly nested element.
 * </ul>
 * This is equivalent to applying both {@link MethodsNotNullByDefault} and
 * {@link ParametersNotNullByDefault};
 */
@Documented
@Nonnull
@TypeQualifierDefault({METHOD, PARAMETER})
@Retention(RUNTIME)
public @interface InterfaceNotNullByDefault {
}
